        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullDesc = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeInSpecialization = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    DoctorsId = table.Column<int>(type: "integer", nullable: false),
                    PolyclinicsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "175eb6e7-b77d-4f21-8ddf-7c0a3ff12faa", "912904b4-b127-42dc-b79e-495ca0cfd810", "admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "98148311-caa9-478a-9193-b570f8c270ea", 0, "1000e5c1-89d0-43e1-9ac6-a501c71db02b", "my@email.com", true, false, null, "MY@EMAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAEITyi/GNhysDY7cx540AgRFSCPP3wL7nbdAFQEukxe47im5zzEgDlVZ373Ag+wz42w==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "175eb6e7-b77d-4f21-8ddf-7c0a3ff12faa", "98148311-caa9-478a-9193-b570f8c270ea" });
